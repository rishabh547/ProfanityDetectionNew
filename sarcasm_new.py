...
# Tokenizer Function
def tokenize_string(test_line):
    tokenizer_obj = Tokenizer()
    tokenizer_obj.fit_on_texts(test_line)
    new_seq = tokenizer_obj.texts_to_sequences(test_line)
    return new_seq
...
def predict_sarcasm(s):
    ...
    test_sequences = tokenize_string(test_lines)
